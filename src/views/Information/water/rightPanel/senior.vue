  ...
  <div class="seniorbox">
    <div class="senior">
      ...
      <div class="seniorC">
        ...
        <el-input v-model="sRain" size="small" style="width:97px" placeholder="" /></el-input>
        至
        <el-input v-model="eRain" size="small" style="width:97px" placeholder="" /></el-input>(mm)
      </div>
      <div class="seniorB">
...
export default {
    ...
    mounted(){
     ...
     methods:{
      ...
      ...mapActions('water',['getSeniorData'])
    },
    computed: {
        ...mapGetters('water', ['seniorList','type','gap','startTm','endTm']),
